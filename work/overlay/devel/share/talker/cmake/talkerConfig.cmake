...
if(NOT "" STREQUAL "")
  ...
  foreach(idir ${absolute_include_dirs})
    if(IS_ABSOLUTE ${idir} AND IS_DIRECTORY ${idir})
      set(include ${idir})
    elseif(IS_DIRECTORY C:/work/overlay/src/talker/${idir})
      set(include C:/work/overlay/src/talker/${idir})
    else()
      message(FATAL_ERROR "Project 'talker' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in 'C:/work/overlay/src/talker/${idir}'.  Ask the maintainer 'Un Known <un@known.com>' to fix it.")
    endif()
